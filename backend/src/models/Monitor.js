...
const monitorSchema = new mongoose.Schema({
  ...
  type: { type: String, required: true, enum: ['cloudflare', 'adguard', 'adguardhome', 'hms', 'ultracc', 'syncthing', 'http', 'ping', 'proxmox', 'immich', 'portainer', 'ssh', 'heartbeat', 'docker', 'unraid', 'speedtest', 'homeassistant', 'jellyfin', 'dns', 'mysql', 'redis', 'mongodb', 'tailscale', 'ollama', 'openwebui', 'sonarr', 'radarr', 'prowlarr', 'overseerr', 'portforward', 'qbittorrent', 'autobrr', 'rclone', 'hetzner', 'dispatcharr'] },
