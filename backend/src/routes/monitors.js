...
const TYPES = ['cloudflare', 'adguard', 'adguardhome', 'hms', 'ultracc', 'syncthing', 'http', 'ping', 'proxmox', 'immich', 'portainer', 'ssh', 'heartbeat', 'docker', 'unraid', 'jellyfin', 'dns', 'mysql', 'redis', 'mongodb', 'tailscale', 'ollama', 'speedtest', 'homeassistant', 'portforward', 'multistep', 'dispatcharr', 'navidrome'];
